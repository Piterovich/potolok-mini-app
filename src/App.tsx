...
function App() {
  ...
  // ⭐️ ИСПРАВЛЕННЫЕ КЛЮЧИ: Теперь они 100% совпадают с прайсом в Питоне!
  const options = {
    canvases: [
    ...
    profiles: [
      ...
      { id: 'профиль_теневой_6мм_мп', name: 'Теневой (6 мм)' }, // <-- Исправлено
  ...
  const [prices] = useState({
    ...
    profile: { 'профиль_м': 60, 'профиль_теневой_6мм_мп': 350, 'профиль_парящий_мп': 500 }, // <-- Исправлено
